...
subprojects {
    ...
    dependencies {
        ...
        implementation("com.github.Blatzar:NiceHttp:0.4.16") // Untuk HTTP requests
        implementation("org.jsoup:jsoup:1.22.1") // Untuk parsing HTML
        implementation("com.fasterxml.jackson.module:jackson-module-kotlin:2.20.0") // JANGAN DIGANTI ke versi terbaru, karena ada masalah dengan versi terbaru
        implementation("com.fasterxml.jackson.core:jackson-databind:2.20.0") // Untuk serialisasi/deserialisasi JSON
